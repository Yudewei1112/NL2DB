...
**NL2DB** 是一个革命性的智能数据查询系统，它打破了传统数据分析的技术壁垒。通过先进的大语言模型和向量检索技术，让任何人都能用自然语言轻松查询复杂的Excel数据，无需学习SQL或复杂的数据分析工具。
...
| 🚫 传统向量检索 | ✅ NL2DB智能检索 |
|:---:|:---:|
| ![传统向量检索](images/未开启MCP(普通向量检索).png) | ![NL2DB智能检索](images/开启MCP_1.png) |
| 无法检索到相关数据，难以理解表格结构 | NL2DB能够精准理解表头，准确返回数据 |
